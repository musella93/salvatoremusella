    ...
    <>
      ...
      <main className="relative z-10 min-h-screen flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <motion.nav className="w-full max-w-[320px] mx-auto space-y-2" variants={fadeInUp} aria-label="Primary actions">
            ...
            >
              <span className="cta-content">
                ...
                <span className="font-medium">View Credentials</span>
              </span>
            </a>
